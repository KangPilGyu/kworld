...
public class NaverLoginService {
		...
		private final static String REDIRECT_URI = "http://ec2-54-180-121-186.ap-northeast-2.compute.amazonaws.com/login/naver";
		...
		public void makeAccessToken(HttpSession session, String code, String state) throws IOException{
		...
		public String getUserProfile() throws IOException{
	    	...
	    	oauthService.signRequest(this.oauthToken, request);
